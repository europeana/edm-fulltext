...
public class FullTextResource implements TextReference
{
    ...
    public FullTextResource() { this(null, null, null, null, null); }
    ...
    public String           getResourceURL() { return _url;       }
    public String           getRights()      { return _rights;    }
    public String           getRecordURI()   { return _recordURI; }
    public FullTextResource getResource()    { return this;       }

    public void setString(String str)        { _str = str;        }
    public void setLanguage(String lang)     { _lang = lang;      }
    public void setURL(String url)           { _url = url;        }
    public void setRights(String rs)         { _rights = rs;      }
    public void setRecordURI(String rURI)    { _recordURI = rURI; }
    

    public boolean hasLanguage() { return (_lang != null); }
